  ...
  return (
    <div
      className="
        ...
        xl:justify-center xl:items-center xl:flex-nowrap xl:max-w-[1490px] xl:mx-auto
        "
    >
      ...
      {/* Text content */}
      <div className="w-full xl:min-w-[445px] xl:max-w-[445px] mx-8 md:mx-16 xl:mx-0! flex flex-col gap-6 xl:gap-8 items-center">
